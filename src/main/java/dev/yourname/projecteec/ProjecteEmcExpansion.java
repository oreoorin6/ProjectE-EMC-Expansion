...
/**
 * ProjectE EMC Expansion for Minecraft 1.20.1
 * Clean, working implementation for release
 */
...
public class ProjecteEmcExpansion {
    ...
    public ProjecteEmcExpansion() {
        ...
        LOGGER.info("ProjectE EMC Expansion {} loaded for Minecraft 1.20.1", VERSION);
    }
    
    private void setup(final FMLCommonSetupEvent event) {
        LOGGER.info("Setting up ProjectE EMC Expansion for MC 1.20.1...");
