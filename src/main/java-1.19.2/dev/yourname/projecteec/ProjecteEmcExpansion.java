...
/**
 * ProjectE EMC Expansion for Minecraft 1.19.2
 * Deep Dark update with sculk blocks, echo shards, and recovery compass
 */
...
public class ProjecteEmcExpansion {
    ...
    public ProjecteEmcExpansion() {
        ...
        LOGGER.info("ProjectE EMC Expansion {} loaded for Minecraft 1.19.2", VERSION);
    }
    
    private void setup(final FMLCommonSetupEvent event) {
        LOGGER.info("Setting up ProjectE EMC Expansion for MC 1.19.2...");
