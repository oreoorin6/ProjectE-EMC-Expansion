...
/**
 * ProjectE EMC Expansion for Minecraft 1.21.1
 * Latest version with modern API and updated deprecation handling
 */
...
public class ProjecteEmcExpansion {
    ...
    public ProjecteEmcExpansion(IEventBus modEventBus, ModContainer modContainer) {
        // Modern constructor for 1.21.1
        
        // Register setup event
        modEventBus.addListener(this::setup);
        
        // Register configuration using modern method
        modContainer.registerConfig(ModConfig.Type.COMMON, ProjecteConfig.SPEC);
        
        LOGGER.info("ProjectE EMC Expansion {} loaded for Minecraft 1.21.1", VERSION);
    }
    
    private void setup(final FMLCommonSetupEvent event) {
        LOGGER.info("Setting up ProjectE EMC Expansion for MC 1.21.1...");
